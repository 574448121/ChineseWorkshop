...
{
    public static final PropertyEnum<BlockCWPillarsCore.EnumAxis> Column_AXIS = PropertyEnum.<BlockCWPillarsCore.EnumAxis>create("axis", BlockCWPillarsCore.EnumAxis.class);
    ...
    {
        return this.getStateFromMeta(meta).withProperty(Column_AXIS, BlockCWPillarsCore.EnumAxis.fromFacingAxis(facing.getAxis()));
    }
