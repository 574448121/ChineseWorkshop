...
public class ClientHandler {
    ...
    public static void onKeyInput(KeyInputEvent event) {
        ...
        if (mc.currentScreen == null && mc.player != null && mc.isGameFocused() && event.getAction() == 1 && kbSelect.isActiveAndMatches(InputMappings.getInputByCode(event.getKey(), event.getScanCode()))) {
