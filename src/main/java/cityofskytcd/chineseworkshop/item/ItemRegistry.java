...
public class ItemRegistry
{
    ...
    {
        event.getRegistry().registerAll(new ItemCWLogo("logo"), new ItemCW("black_clay"), new ItemCW("black_brick"), new ItemCWDoor("door", CWBlocks.DOOR), new ItemCWDoor("high_door", CWBlocks.HIGH_DOOR), new ItemCWBlock(CWBlocks.BLACK_BRICK_WALL), new ItemCWBlock(CWBlocks.ANDESITE_PAVEMENT), new ItemCWBlock(CWBlocks.RED_PILLARS), new ItemCWBlock(CWBlocks.DARK_GREEN_PILLARS), new ItemCWBlock(CWBlocks.WHITE_GRAY_WALLS), new ItemCWBlock(CWBlocks.STONE_TOWER_LAMP), new ItemCWBlock(CWBlocks.RED_LANTERN), new ItemCWBlock(CWBlocks.CANDLE), new ItemCWBlock(CWBlocks.WHITE_LANTERN), new ItemCWBlock(CWBlocks.BRACKET_SET), new ItemCWBlock(CWBlocks.MEN_DUN), new ItemCWBlock(CWBlocks.THRESHOLD), new ItemCWBlock(CWBlocks.CARVING), new ItemCWBlock(CWBlocks.TREE_ALTAR), new ItemCWBlock(CWBlocks.BENCH), new ItemCWBlock(CWBlocks.TABLE), new ItemCWBlock(CWBlocks.WHITE_GRAY_WALLS_STAIRS), new ItemCWBlock(CWBlocks.PAPER_WINDOW), new ItemCWBlock(CWBlocks.DIORITE_FENCE), new ItemCWBlock(CWBlocks.SMALL_BLACK_BRICK_WALL), new ItemCWBlock(CWBlocks.SMALL_WHITE_GRAY_WALLS), new ItemCWBlock(CWBlocks.OAK_CHINESE_FENCE), new ItemCWBlock(CWBlocks.ANDESITE_FENCE), new ItemCWBlock(CWBlocks.IMPLICATE), new ItemCWBlock(CWBlocks.ANDESITE_PAVEMENT_STAIRS), new ItemCWBlock(CWBlocks.OAK_WALL),
                // new ItemCWBlock(CWBlocks.DOOR),
                // new ItemCWBlock(CWBlocks.HIGH_DOOR),
                new ItemCWBlock(CWBlocks.UPPER_DOOR_FRAME), new ItemCWBlock(CWBlocks.BLACK_TILE_ROOF), new ItemCWBlock(CWBlocks.BLACK_TILE_RIDGE_ROOF), new ItemCWBlock(CWBlocks.BLACK_TILE_RIDGE_ROOF_TOP), new ItemCWBlock(CWBlocks.BLACK_TILE_RIDGE_ROOF_L), new ItemCWBlock(CWBlocks.BLACK_TILE_RIDGE_ROOF_EDGE), new ItemCWBlock(CWBlocks.BLACK_TILE_RIDGE_ROOF_T), new ItemCWBlock(CWBlocks.BLACK_TILE_RIDGE_ROOF_X), new ItemCWBlock(CWBlocks.BLACK_TILE_RIDGE_ROOF_J), new ItemCWBlock(CWBlocks.BLACK_TILE_ROOF_J), new ItemCWBlock(CWBlocks.BLACK_TILE_ROOF_SLAB), new ItemCWBlock(CWBlocks.BLACK_TILE_ROOF_SLAB_TOP), new ItemCWBlock(CWBlocks.THIN_WHITE_GRAY_WALLS), new ItemCWBlock(CWBlocks.BLACK_TILE_ROOF_EDGE_Y), new ItemCWBlock(CWBlocks.BLACK_TILE_ROOF_EDGE_Z), new ItemCWBlock(CWBlocks.BLACK_TILE_ROOF_EDGE_YJ), new ItemCWBlock(CWBlocks.BLACK_TILE_ROOF_EDGE_ZJ), new ItemCWBlock(CWBlocks.BLACK_TILE_ROOF_EDGE_SLAB_Z), new ItemCWBlock(CWBlocks.BLACK_TILE_ROOF_EDGE_SLAB_TOP_Z), new ItemCWBlock(CWBlocks.BLACK_TILE_ROOF_EDGE_SLAB_Y), new ItemCWBlock(CWBlocks.BLACK_TILE_ROOF_EDGE_SLAB_TOP_Y));
    }
    ...
    public static void onModelRegister(ModelRegistryEvent event)
    {
        ...
        ModelUtil.mapItemModel(CWItems.RED_PILLARS);
        ModelUtil.mapItemModel(CWItems.DARK_GREEN_PILLARS);
        ModelUtil.mapItemModel(CWItems.WHITE_GRAY_WALLS);
        ...
        ModelUtil.mapItemModel(CWItems.WHITE_GRAY_WALLS_STAIRS);
        ...
        ModelUtil.mapItemModel(CWItems.THIN_WHITE_GRAY_WALLS);
