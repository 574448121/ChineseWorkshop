...
//		GameRegistry.addShapelessRecipe(new ItemStack(BlockRegistry.darkGreenPillars, 2),
...
//		/* 灯 */
//		GameRegistry.addShapedRecipe(new ItemStack(BlockRegistry.stoneTowerLamp, 3), new Object[] { " * ", "*@*", "#!#",
//				'#', Blocks.STONE, '*', Blocks.STONEBRICK, '@', Blocks.REDSTONE_LAMP, '!', Blocks.REDSTONE_TORCH });
//		GameRegistry.addShapedRecipe(new ItemStack(BlockRegistry.theLantern, 6), new Object[] { "#*#", "#!#", "#*#", '#',
...
//				new Object[] { "###", "###", '#', Items.STICK });
//		GameRegistry.addShapedRecipe(new ItemStack(BlockRegistry.menDun, 4), new Object[] { " **", " **", "###", '#',
...
//		GameRegistry.addShapedRecipe(new ItemStack(BlockRegistry.blackTileRidgeRoof, 16),
//				new Object[] { "###", "###", '#', ItemRegistry.blackBrick });
//		GameRegistry.addShapedRecipe(new ItemStack(BlockRegistry.blackTileRidgeRoofL, 5),
//				new Object[] { "#  ", "#  ", "###", '#', BlockRegistry.blackTileRidgeRoof });
//		GameRegistry.addShapedRecipe(new ItemStack(BlockRegistry.blackTileRidgeRoofEdge, 3),
//				new Object[] { "#", "#", "#", '#', BlockRegistry.blackTileRidgeRoof });
//		GameRegistry.addShapedRecipe(new ItemStack(BlockRegistry.blackTileRidgeRoofT, 4),
//				new Object[] { "###", " # ", '#', BlockRegistry.blackTileRidgeRoof });
//		GameRegistry.addShapedRecipe(new ItemStack(BlockRegistry.blackTileRidgeRoofX, 5),
//				new Object[] { "# #", " # ", "# #", '#', BlockRegistry.blackTileRidgeRoof });
//		GameRegistry.addShapedRecipe(new ItemStack(BlockRegistry.blackTileRidgeRoofJ, 3),
//				new Object[] { "#  ", " # ", "  #", '#', BlockRegistry.blackTileRidgeRoof });
//		GameRegistry.addShapedRecipe(new ItemStack(BlockRegistry.blackTileRoofj, 3),
//				new Object[] { "#  ", " # ", "  #", '#', BlockRegistry.blackTileRoof });
//		GameRegistry.addShapedRecipe(new ItemStack(BlockRegistry.thinWhiteGrayWalls, 18),
//				new Object[] { "#", "#", "#", '#', BlockRegistry.whiteGrayWalls });
//		GameRegistry.addShapedRecipe(new ItemStack(BlockRegistry.blackTileRoofEdgeZ, 6),
//				new Object[] { " #", "#*", '#', BlockRegistry.whiteGrayWalls, '*', BlockRegistry.blackTileRoof });
//		GameRegistry.addShapedRecipe(new ItemStack(BlockRegistry.blackTileRoofEdgeY, 6),
//				new Object[] { "# ", "*#", '*', BlockRegistry.whiteGrayWalls, '#', BlockRegistry.blackTileRoof });
//		GameRegistry.addShapelessRecipe(new ItemStack(BlockRegistry.blackTileRoofEdgeYJ, 1),
//				new Object[] { ItemRegistry.blackBrick, BlockRegistry.blackTileRoofEdgeY });
//		GameRegistry.addShapelessRecipe(new ItemStack(BlockRegistry.blackTileRoofEdgeZJ, 1),
...
//		GameRegistry.addShapedRecipe(new ItemStack(BlockRegistry.andesitePavement, 2),
//				new Object[] { "#*", "*#", '#', new ItemStack(Blocks.STONE, 1, 6), '*', ItemRegistry.blackBrick });
//		// 白灰墙阶梯
//		GameRegistry.addShapedRecipe(new ItemStack(BlockRegistry.whiteGrayWallsStairs, 6),
//				new Object[] { "#  ", "## ", "###", '#', BlockRegistry.whiteGrayWalls });
//		// 纸窗
...
//		// 小黑砖墙
//		GameRegistry.addShapedRecipe(new ItemStack(BlockRegistry.smallBlackBrickWall, 6),
//				new Object[] { "###", "###", '#', BlockRegistry.blackBrickWall });
//		// 小白灰墙
//		GameRegistry.addShapedRecipe(new ItemStack(BlockRegistry.smallWhiteGrayWalls, 6),
//				new Object[] { "###", "###", '#', BlockRegistry.whiteGrayWalls });
//		// 橡木中式栅栏
//		GameRegistry.addShapedRecipe(new ItemStack(BlockRegistry.oakChineseFence, 10), new Object[] { "#*#", "#*#", '#',
...
//		// 安山岩路面楼梯
//		GameRegistry.addShapedRecipe(new ItemStack(BlockRegistry.andesitePavementStairs, 6),
...
//		/* 屋顶 */
//		// 黑瓦屋顶半砖
//		GameRegistry.addShapedRecipe(new ItemStack(BlockRegistry.blackTileRoofSlab, 6),
//				new Object[] { "###", '#', BlockRegistry.blackTileRoof });
//		// 黑瓦屋顶半砖top
//		GameRegistry.addShapedRecipe(new ItemStack(BlockRegistry.blackTileRoofSlabTop, 12),
//				new Object[] { "###", "###", '#', BlockRegistry.blackTileRoof });
//		// 黑瓦屋脊top
//		GameRegistry.addShapedRecipe(new ItemStack(BlockRegistry.blackTileRidgeRoofTop, 3),
//				new Object[] { "###", '#', BlockRegistry.blackTileRidgeRoof });
//		/* 薄墙 */
//		// 黑瓦屋顶半砖边缘左
//		GameRegistry.addShapedRecipe(new ItemStack(BlockRegistry.blackTileRoofEdgeSlabZ, 4),
//				new Object[] { "##", '#', BlockRegistry.blackTileRoofEdgeZ });
//		// 黑瓦屋顶半砖边缘左TOP
//		GameRegistry.addShapedRecipe(new ItemStack(BlockRegistry.blackTileRoofEdgeSlabTopZ, 6),
//				new Object[] { "###", '#', BlockRegistry.blackTileRoofEdgeZ });
//		// 黑瓦屋顶半砖边缘右
//		GameRegistry.addShapedRecipe(new ItemStack(BlockRegistry.blackTileRoofEdgeSlabY, 4),
//				new Object[] { "##", '#', BlockRegistry.blackTileRoofEdgeY });
//		// 黑瓦屋顶半砖边缘右TOP
//		GameRegistry.addShapedRecipe(new ItemStack(BlockRegistry.blackTileRoofEdgeSlabTopY, 6),
//				new Object[] { "###", '#', BlockRegistry.blackTileRoofEdgeY });
	}

	private static void registerSmelting() {
//		/* 装饰 */
//		GameRegistry.addSmelting(ItemRegistry.blackClay, new ItemStack(ItemRegistry.blackBrick), 0.5F);
	}
